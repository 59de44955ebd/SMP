...
This engine supports less features, container formats and codecs than the other engines, but has the benefit of minimum extra file size, since WebView2 is already provided by the OS.
