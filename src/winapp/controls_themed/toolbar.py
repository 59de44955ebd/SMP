...
DARK_SEPARATOR_BRUSH = DARK_SEPARATOR_BRUSH #gdi32.CreateSolidBrush(0x424242)  #DARK_BORDER_BRUSH
...
#        self.set_font()
    ...
    def _on_WM_NCPAINT(self, hwnd, wparam, lparam):
        ...
        user32.FillRect(hdc, byref(RECT(0, 0, rc.right - rc.left, 1)), DARK_SEPARATOR_BRUSH)
            ...
            if nmcd.dwDrawStage == CDDS_PREPAINT:
                ...
                if self.bottom_divider:
                    ...
                    if self.is_vertical:
                        ...
                        rc.top = rc.bottom - 1
                    user32.FillRect(nmtb.nmcd.hdc, byref(rc), DARK_SEPARATOR_BRUSH if self.is_dark else SEPARATOR_BRUSH)
